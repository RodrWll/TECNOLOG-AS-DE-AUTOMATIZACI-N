...
```
Se adjuntan capturas de la compilación y ejecución del código en la terminal de Ubuntu.

![alt text](image.png)

Ejecución del código en la terminal de Ubuntu. El horno itera, se lee la temperatura , se apaga y se prende ya que no ha llegado a 120 y asi sucesivamente.
